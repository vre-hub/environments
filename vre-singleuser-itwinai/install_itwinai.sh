...
# Exactly the same script that on withot the parts that break the installation (deepspeed and horovod)
# Lines 88 to 175
# https://github.com/interTwin-eu/itwinai/blob/main/env-files/torch/generic_torch.sh
