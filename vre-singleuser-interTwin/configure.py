...
# Adding 'rucio_base_url' too - from debugging experience
    ...
    instance_config = {
        "name": os.getenv('RUCIO_NAME', 'rucio-intertwin-testbed.desy.de'),
        "display_name": os.getenv('RUCIO_DISPLAY_NAME', 'interTwinRUCIO'),
        "rucio_base_url": os.getenv('RUCIO_BASE_URL', 'https://rucio-intertwin-testbed.desy.de'),
        "rucio_auth_url": os.getenv('RUCIO_AUTH_URL', 'https://rucio-intertwin-testbed-auth.desy.de'),
        "rucio_ca_cert": os.getenv('RUCIO_CA_CERT', '/opt/conda/lib/python3.9/site-packages/certifi/cacert.pem'),
        "site_name": os.getenv('RUCIO_SITE_NAME', 'VEGA'),
...
def write_rucio_config():
    ...
    client_config = {
        ...
        'ca_cert': os.getenv('RUCIO_CA_CERT', '/certs/rucio_ca.pem'),  # /opt/conda/lib/python3.9/site-packages/certifi/cacert.pem ?
